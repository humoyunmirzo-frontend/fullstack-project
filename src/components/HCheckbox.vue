...
.color-primary {
  svg {
    @apply text-primary hover:drop-shadow-lg hover:drop-shadow-[0_35px_35px_rgb(10,45,201)];
  }
}
.color-secondary {
  svg {
    @apply text-secondary hover:drop-shadow-lg hover:drop-shadow-[0_35px_35px_rgb(10,45,201)];
  }
}
.color-danger {
  svg {
    @apply text-danger hover:drop-shadow-lg hover:drop-shadow-[0_35px_35px_rgb(10,45,201)];
  }
}
</style>
