...
<template>
  <table class="w-full overflow-x-scroll text-left text-sm text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      <tr v-for="(row, rowIndex) in props.rows" :key="rowIndex" class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
